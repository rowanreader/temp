...
function allQuestions(){
	if (question == 1){
		...
		document.getElementById("a2label").innerHTML = "No"
		if (question == 2){
			document.getElementById("ques").innerHTML = "Please contact your therapist. </br>Are you comfortable with the digital tools recommended in Module 5 (i.e. Navigating Roadblocks)?";
		}
		else{
			document.getElementById("ques").innerHTML = "Are you comfortable with the digital tools recommended in Module 5 (i.e. Navigating Roadblocks)?";
		...
		if (question == 4){
				...
				document.getElementById("ques").innerHTML = "Please see Module 5 on how to minimize distractions and maintain focus. </br> Did you receive the Summary Sheet for Module 5 via email?";	
		}
	}
